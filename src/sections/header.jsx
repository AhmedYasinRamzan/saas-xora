...
const NavLink = ({ title }) => (
    <LinkScroll to={title} smooth={true} duration={500} className='base-bold text-p4 uppercase transition-colors duration-500 hover:text-p1 cursor-pointer max-lg:my-4 max-lg:h5'>
        {title}
    </LinkScroll>
)
    ...
    const [isOpen, setIsOpen] = useState(false);
     ...
     <header className='fixed top-0 left-0 w-full z-50 py-10'>
       <div className='container flex h-14 items-center max-lg:px-5'>
         ...
         <button className='lg:hidden z-2 size-10 border-s4/25
